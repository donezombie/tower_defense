from tower_defense.tower_aoe_bullet import *
    ...
    def shoot(self,e_x,e_y):
        ...
        if tower_defense.game_object.hasEnemy == True:
            if self.shoot_lock == False:
                bullet = TowerBulletAOE(self.x,self.y,e_x,e_y)
                add(bullet)
                bullet2 = TowerBulletAOE(self.x,self.y,e_x,e_y)
                add(bullet2)
                bullet3 = TowerBulletAOE(self.x,self.y,e_x,e_y)
                add(bullet3)
                # bullet = TowerBullet()
